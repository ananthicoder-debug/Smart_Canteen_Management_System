    ...
    const loadOrders = () => {
      fetchOrders()
        .then((items) => {
          ...
          const preparing = items.filter((o: Order) => o.status === "preparing").length
          const ready = items.filter((o: Order) => o.status === "ready").length
          const completed = items.filter((o: Order) => o.status === "completed").length
